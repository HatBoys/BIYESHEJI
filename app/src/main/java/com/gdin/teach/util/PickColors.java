...
public abstract class PickColors {
    ...
    public static void computeAxisAutoValues(float start, float stop, int steps, AxisAutoValues outValues) {
        ...
        double interval = PickColors.roundToOneSignificantFigure(rawInterval);
        ...
        double last = PickColors.nextUp(Math.floor(stop / interval) * interval);
